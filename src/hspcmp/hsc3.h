...
// Legacy hsc3_getruntime callers provide a 256-byte output buffer.
#define HSC3_RUNTIME_OUTPUT_SIZE 256
...
public:
	...
	int GetRuntimeFromHeader( const char *fname, std::string& res );
