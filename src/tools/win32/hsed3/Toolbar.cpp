...
TBBUTTON tbb[] = 
     {
         ...
         {   1, IDM_OPEN, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 1 },
         {   2, IDM_SAVE, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 2 },
 
         { 0, 0, TBSTATE_ENABLED, TBSTYLE_SEP, 0, 0, 0, 0 },

         { 3, IDM_CUT, TBSTATE_ENABLED, TBSTYLE_BUTTON,  0, 0, 0, 3 },
         { 4, IDM_COPY, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 4 },
         { 5, IDM_PASTE, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 5 },

         { 0, 0, TBSTATE_ENABLED, TBSTYLE_SEP, 0, 0, 0, 0 },

         { 6, IDM_UNDO, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 6 },
         { 7, IDM_FIND, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 7 },

         { 0, 0, TBSTATE_ENABLED, TBSTYLE_SEP, 0, 0, 0, 0 },

         { 8, IDM_COMP, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 8 },
         { 9, IDM_MKOBJ, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 9 },
         { 10, IDM_COMP3, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 10 }
     } ;
