...
MSBuild win32/hsp3cl.sln -t:Rebuild -p:Configuration=Release;Platform="x64"
MSBuild win32/hsp3cl.sln -t:Rebuild -p:Configuration=hsp3cl_hrt;Platform="x64"
...
copy /B /Y x64\Release\hsp3_64.exe ..\..\package\win64
copy /B /Y x64\hrt_release\hsp3_64.hrt ..\..\package\win64\runtime
copy /B /Y win32\Release\hsp3cl.exe ..\..\package\win32
copy /B /Y win32\hsp3cl_hrt\hsp3cl.hrt ..\..\package\win32\runtime
copy /B /Y win32\x64\Release\hsp3cl_64.exe ..\..\package\win64
copy /B /Y win32\x64\hsp3cl_hrt\hsp3cl_64.hrt ..\..\package\win64\runtime
