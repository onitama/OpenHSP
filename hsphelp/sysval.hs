...
^
※このシステム変数は、マクロとしてhspdef.as内で定義されています。
※html5,iOS,androidなどのシステムではこの値は取得できません。
...
X軸に対する加速度を実数(m/s^2)で取得したものになります。(重力加速度9.8m/s^2を含んだ数値が取得されます。)
加速度センサーが使用できない環境では、0.0が取得されます。
^
※このシステム変数は、マクロとしてhspdef.as内で定義されています。
※HSP3Dish上ではデバイスによって取得できない場合があります。
※html5の場合は、https接続が必要になります。ブラウザによってはサポートされないのでご注意ください。
...
%inst
加速度センサーが使用可能な環境で、センサーの値を取得します。
Y軸に対する加速度を実数(m/s^2)で取得したものになります。(重力加速度9.8m/s^2を含んだ数値が取得されます。)
加速度センサーが使用できない環境では、0.0が取得されます。
^
※このシステム変数は、マクロとしてhspdef.as内で定義されています。
※デバイスによって取得できない場合があります。
※html5の場合は、https接続が必要になります。ブラウザによってはサポートされないのでご注意ください。
...
%inst
加速度センサーが使用可能な環境で、センサーの値を取得します。
Z軸に対する加速度を実数(m/s^2)で取得したものになります。(重力加速度9.8m/s^2を含んだ数値が取得されます。)
加速度センサーが使用できない環境では、0.0が取得されます。
^
※このシステム変数は、マクロとしてhspdef.as内で定義されています。
※デバイスによって取得できない場合があります。
...
%inst
傾きセンサーが使用可能な環境で、センサーの値を取得します。
X軸に対する傾き角度(Degree)を取得したものになります。
傾きセンサーが使用できない環境では、0.0が取得されます。
^
※このシステム変数は、マクロとしてhspdef.as内で定義されています。
※デバイスによって取得できない場合があります。
※html5の場合は、https接続が必要になります。ブラウザによってはサポートされないのでご注意ください。
...
%inst
傾きセンサーが使用可能な環境で、センサーの値を取得します。
Y軸に対する傾き角度(Degree)を取得したものになります。
傾きセンサーが使用できない環境では、0.0が取得されます。
^
※このシステム変数は、マクロとしてhspdef.as内で定義されています。
※デバイスによって取得できない場合があります。
...
%inst
傾きセンサーが使用可能な環境で、センサーの値を取得します。
Z軸に対する傾き角度(Degree)を取得したものになります。
傾きセンサーが使用できない環境では、0.0が取得されます。
^
※このシステム変数は、マクロとしてhspdef.as内で定義されています。
※デバイスによって取得できない場合があります。
