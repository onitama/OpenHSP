...
The result is a real number in radians, in the range -M_PI/2 to M_PI/2 (from -90属 to 90属 in degrees).
...
The result is a real number in radians, in the range 0 to M_PI (from 0属 to 180属 in degrees).
