...
Results are given in real and radians, in the range -M_PI / 2 to M_PI / 2 (-90 属 to 90 属 in frequency).
...
Results are given in real and radians, ranging from 0 to M_PI (0 属 to 180 属 in frequency).
